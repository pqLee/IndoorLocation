...
import com.intel.test.locationdemo.data.FingerprintMatcher;
import com.intel.test.locationdemo.data.HausdorffDistance;
import com.intel.test.locationdemo.data.MovingAverage;
...
public class TestActivity extends Activity implements SensorEventListener {
    ...
    private float[] mNewestMagData = new float[3];
    private float[] mOlderMagData = new float[3];
    ...
    private FingerprintMatcher mMatcher;
    private HausdorffDistance mHauMatcher;
...
//        }
        ...
        mMatcher = new FingerprintMatcher();
        mHauMatcher = new HausdorffDistance();
    }
